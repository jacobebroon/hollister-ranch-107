...
export const metadata = {
  title: "Map & Access — Rancho Alegria",
};
      ...
      <section className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
        <div className="overflow-hidden rounded-2xl border border-cream-line shadow-lg">
          <iframe
            ...
            src="https://maps.google.com/maps?q=Hollister+Ranch%2C+Gaviota%2C+CA&z=12&output=embed"
      ...
      <section className="border-y border-cream-line bg-sand-deep/40">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2">
            <TiltCard src={photoUrl("ranch-004")} alt="Aerial view of Rancho Alegria and the Pacific" />
            <TiltCard src={photoUrl("ranch-005")} alt="Aerial view of the residence and motor court" />
            <TiltCard src={photoUrl("dsc-0050")} alt="Rolling hills of Hollister Ranch" />
            <TiltCard src={photoUrl("img-20150119-123532632")} alt="Fog rolling over the ranch's coastal hills" />
          </div>
        </div>
      </section>
