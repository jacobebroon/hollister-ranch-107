    ...
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
        <path
          ...
          strokeLinejoin="round"
        />
        <path className="weather-drift" d="M3 13h18M3 17h18M5 21h14" strokeLinecap="round" />
      </svg>
    );
  }
    ...
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
        <path
          ...
          strokeLinejoin="round"
        />
        <path className="weather-drop" d="M12.5 17l-2 3.5h2.5L11 24" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
    ...
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
        <path
          ...
          strokeLinejoin="round"
        />
        <path className="weather-drop" d="M9 18v4M12 18v4M15 18v4" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path className="weather-drop" d="M9 18l-1 3M13 18l-1 3M17 18l-1 3" strokeLinecap="round" />
    </svg>
  );
}
